            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex gap-3">
                {[
                  ...
                  {
                    label: "Instagram",
                    href: "https://www.instagram.com/primefintaxconsultancy",
                    icon: (
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {
                    label: "Facebook",
                    href: "https://www.facebook.com/primefintaxconsultancy",
                    icon: (
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {
                    label: "LinkedIn",
                    href: "https://www.linkedin.com/company/primefintaxconsultancy",
                    icon: (
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
